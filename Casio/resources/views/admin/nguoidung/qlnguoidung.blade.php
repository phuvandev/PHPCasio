          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <table id="datatable" class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                      <th style="text-align: center;">Mã ND</th>
                      <th style="text-align: center;">Tài khoản</th>
                      <th style="text-align: center;">Mật khẩu</th>
                      <th style="text-align: center;">Email</th>
                      <th style="text-align: center;">Họ tên</th>
                      
                      <th style="text-align: center;">Loại quyền</th>
                  ...
                  @foreach ($nguoidung as $n)
                    <tr>
                      ...
                      @if($n->role != 'Khách hàng')
                        ...
                        <td style="text-align: center;">
                          <form action="/qlnguoidung_update/{{$n->id}}" method="GET">
                        ...
                        <td style="text-align: center;">
                          <form action="/deleteNguoiDung/{{$n->id}}" method="POST" id="delete-form">
                            @csrf
                            @method('DELETE')
              ...
              <div class="paginate" style="text-align: center">
                {{$nguoidung->appends(request()->all())->links()}}
              </div>
              <!-- End phân trang-->
