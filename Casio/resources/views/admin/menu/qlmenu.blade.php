            ...
            <div class="x_content">
              ...
              <div style=" margin-bottom: 10px;">
                <a class="text-muted font-13 m-b-30">
                  <form action="/qlmenu_create" method="GET">
                ...
                <tbody>
                  @foreach ($menu as $m)
                    <tr>
                      ...
                      <td style="text-align: center;">{{$m->TenMenu}}</td>
                      <td style="text-align: center;">{{$m->STT}}</td>
                      <td style="text-align: center;"><a href="{{$m->Link}}">{{$m->Link}}</a></td>
                      <td style="text-align: center;">
                        <form action="/qlmenu_update/{{$m->id}}" method="GET">
                      ...
                      <td style="text-align: center;">
                        <form action="/deleteMenu/{{$m->id}}" method="POST" id="delete-form">
                          @csrf
                          @method('DELETE')
