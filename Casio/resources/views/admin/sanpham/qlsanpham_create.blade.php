    ...
    <div class="">
      <div class="page-title">
        <div class="title_left">
          <h3>Quản lý Sản phẩm - Chức năng Tạo mới</h3>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <!--------------------------------------------------------------------------------------------->
            <div class="x_content">
                <form  novalidate name="frmSanPham" id="frmSanPham" class="form-horizontal row-border" action="/createSanPham" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                        <div class="">
                            <div class="form-group">
                                ...
                                <div class="col-md-7"> 
                                    <input type="text" id="idTenSP" class="form-control" name="TenSP" /> 
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7"> 
                                    <input type="text" id="idGiaBan" class="form-control" name="GiaBan" /> 
                                </div>
                            </div>
                            <div class="form-group">
