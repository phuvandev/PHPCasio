            ...
            <div class="x_content">
              ...
              <div style=" margin-bottom: 10px;">
                <a class="text-muted font-13 m-b-30">
                  <form action="/qlslide_create" method="GET">
              ...
              <table id="datatable" class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                      <th style="text-align: center;">Mã Slide</th>
                    ...
                    <tr>
                      ...
                      @if($s->Anh != '')
                        <td style="text-align: center; max-width: 160px;">
                          <img  style="width: 300px; height: 200px;" src="assets/custom/Anh/Slide/{{$s->Anh}}"/>
                        </td>
                        @else 
                      ...
                      @endif
                      <td style="text-align: center;">{{$s->Link}}</td>
                      <td style="text-align: center;">
                        <form action="/qlslide_update/{{$s->id}}" method="GET">
                      ...
                      <td style="text-align: center;">
                        <form action="/deleteSlide/{{$s->id}}" method="POST" id="delete-form">
                          @csrf
                          @method('DELETE')
              ...
              <div class="paginate" style="text-align: center">
                {{$slide->appends(request()->all())->links()}}
              </div>
              <!-- End phân trang-->
            </div>
          </div>
