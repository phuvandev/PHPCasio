    ...
    <div class="">
      <div class="page-title">
        <div class="title_left">
          <h3>Quản lý Người dùng - Chức năng Tạo mới</h3>
        </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            @endif
            <div class="x_content">
                <form  novalidate name="frmNguoiDung" id="frmNguoiDung" class="form-horizontal row-border" action="/createNguoiDung" method="POST">
                    @csrf
                    <div class="col-md-12">
                        <div class="">
                            <div class="form-group">
                                ...
                                <div class="col-md-7"> 
                                    <input type="text" id="idUsername" class="form-control" name="username" /> 
                                </div>
                            </div>
                            <div class="form-group">
                              <label class="col-md-3 control-label" for="input17"> Mật khẩu : </label>
                              <div class="col-md-7"> 
                                  <input type="text" id="idPassword" class="form-control" name="password" /> 
                              </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="input17"> Email :</label>
                                <div class="col-md-7"> 
                                    <input type="text" id="idEmail" class="form-control" name="email" /> 
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7"> 
                                    <input type="text" id="idName" class="form-control" name="name" /> 
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="input17"> Ngày sinh : </label>
                                <div class="col-md-7"> 
                                    <input type="date" id="idDob" class="form-control" name="dob" /> 
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7"> 
                                    <input type="text" id="idAddress" class="form-control" name="address" /> 
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="input17"> SĐT :</label>
                                <div class="col-md-7"> 
                                    <input type="text" id="idPhone" class="form-control" name="phone" /> 
                                </div>
                            </div>
                            <div class="form-group">
