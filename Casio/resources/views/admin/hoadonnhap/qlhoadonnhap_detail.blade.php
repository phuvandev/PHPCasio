    ...
    <div class="">
      <div class="page-title">
        <div class="title_left">
            <h3>Chi tiết Hóa đơn nhập : 
                <a style="color: red;">{{ $hoadonnhap->TenHDN }}</a>
            </h3>
        </div>
