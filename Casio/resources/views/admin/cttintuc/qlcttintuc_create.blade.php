    ...
    <div class="">
      <div class="page-title">
        <div class="title_left">
          <h3>Quản lý Chi tiết Tin tức - Chức năng Tạo mới</h3>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <!--------------------------------------------------------------------------------------------->
            <div class="x_content">
                <form  novalidate name="frmCTTinTuc" id="frmCTTinTuc" class="form-horizontal row-border" action="/createCTTinTuc" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                        <div class="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7"> 
                                    <input type="text" id="idNoiDung" class="form-control" name="NoiDung" /> 
                                </div>
                            </div>
