    ...
    <div class="">
      <div class="page-title">
        <div class="title_left">
          <h3>Quản lý Hóa đơn nhập - Chức năng Sửa</h3>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <!--------------------------------------------------------------------------------------------->
            <div class="x_content">
                <form name="frmHoaDonNhap" id="frmHoaDonNhap" class="form-horizontal row-border" action="/updateHoaDonNhap/{{$hoadonnhap->id}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                        <div class="">
                              <div class="form-group">
                                ...
                                <div class="col-md-7"> 
                                    <input type="text" id="idTenHDN" class="form-control" name="TenHDN" value="{{ $hoadonnhap->TenHDN }}" /> 
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label" for="input17"> Người nhập :</label>
                                <div class="col-md-7"> 
                                    <input readonly type="text" id="idMaND" class="form-control" name="MaND" value="{{ $hoadonnhap->MaND }}" /> 
                                </div>
                              </div>
                              <div class="form-group">
