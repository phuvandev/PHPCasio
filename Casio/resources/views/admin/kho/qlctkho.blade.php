          ...
          <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div style=" margin-bottom: 10px;">
                    ...
                    <form action="/qlctkho_create" method="GET">
                ...
                <table id="datatable" class="table table-striped table-bordered table-hover">
                    ...
                    @foreach ($ctkho as $c)
                        <tr>
                            ...
                            <td style="text-align: center;">{{$c->MaKho}}</td>
                            ...
                            <td style="text-align: center;">
                                <form action="/qlctkho_update/{{$c->id}}" method="GET">
                            ...
                            <td style="text-align: center;">
                                <form action="/deleteCTKho/{{$c->id}}" method="POST" id="delete-form">
                                @csrf
                                @method('DELETE')
