    ...
    <div class="">
      <div class="page-title">
        <div class="title_left">
          <h3>Quản lý Chi tiết ảnh sản phẩm - Chức năng Sửa</h3>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <!--------------------------------------------------------------------------------------------->
            <div class="x_content">
                <form name="frmCTASP" id="frmCTASP" class="form-horizontal row-border" action="/updateCTAnhSanPham/{{$ctanhsanpham->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                        <div class="">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input type="file" id="idAnh" class="form-control" name="Anh" value="{{ $ctanhsanpham->Anh }}"/>
                                </div>
                            </div>
