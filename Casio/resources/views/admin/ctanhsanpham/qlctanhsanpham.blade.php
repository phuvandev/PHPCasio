    ...
    <div class="">
      <div class="page-title">
        <div class="title_left">
          <h3>Quản lý Chi tiết ảnh sản phẩm</h3>
        </div>
            ...
            <div class="x_content">
              ...
              <div style=" margin-bottom: 10px;">
                <a class="text-muted font-13 m-b-30">
                  <form action="/qlctanhsanpham_create" method="GET">
                  ...
                  @foreach ($ctanhsanpham as $c)
                    <tr>
                      ...
                      <td style="text-align: center;">
                          <img  style="width: 120px; height: 120px;" src="assets/custom/Anh/ACT/{{$c->Anh}}"/>
                      </td>
                      <td style="text-align: center;">
                          {{ $c->TenSP }}
                      </td>
                      ...
                      <td style="text-align: center;">
                          <form action="/qlctanhsanpham_update/{{$c->id}}" method="GET">
                      ...
                      <td style="text-align: center;">
                          <form action="/deleteCTAnhSanPham/{{$c->id}}" method="POST" id="delete-form">
                          @csrf
                          @method('DELETE')
              ...
              <div class="paginate" style="text-align: center">
                {{$ctanhsanpham->appends(request()->all())->links()}}
              </div>
              <!-- End phân trang-->
            </div>
          </div>
