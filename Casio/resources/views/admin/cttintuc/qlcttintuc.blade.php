            ...
            <div class="x_content">
              ...
              <div style=" margin-bottom: 10px;">
                <a class="text-muted font-13 m-b-30">
                  <form action="/qlcttintuc_create" method="GET">
                  ...
                  @foreach ($cttintuc as $c)
                    <tr>
                        ...
                        <td style="text-align: center;">
                            @if($c->Anh != '')
                            <img  style="width: 160px; height: 160px;" src="assets/custom/Anh/TT/{{$c->Anh}}"/>
                            @else 
                            <img alt="Không có ảnh"/>
                            @endif
                        </td>
                        <td style="max-width: 400px;">{{Str::limit($c->NoiDung, 300)}}</td>
                        <td style="text-align: center;">{{$c->MaTT}}</td>
                        <td style="text-align: center;">
                            <form action="/qlcttintuc_update/{{$c->id}}" method="GET">
                        ...
                        <td style="text-align: center;">
                            <form action="/deleteCTTinTuc/{{$c->id}}" method="POST" id="delete-form">
                            @csrf
                            @method('DELETE')
              ...
              <div class="paginate" style="text-align: center">
                {{$cttintuc->appends(request()->all())->links()}}
              </div>
              <!-- End phân trang-->
