    ...
    <div class="">
      <div class="page-title">
        <div class="title_left">
          <h3>Quản lý Chi tiết Ảnh sản phẩm - Chức năng Tạo mới</h3>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <!--------------------------------------------------------------------------------------------->
            <div class="x_content">
                <form  novalidate name="frmCTASP" id="frmCTASP" class="form-horizontal row-border" action="/createCTAnhSanPham" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                        <div class="">
