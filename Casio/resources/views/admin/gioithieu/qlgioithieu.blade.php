            ...
            <div class="x_content">
              ...
              <div style=" margin-bottom: 10px;">
                <a class="text-muted font-13 m-b-30">
                  <form action="/qlgioithieu_create" method="GET">
              ...
              <table id="datatable" class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                      <th style="text-align: center;">Mã GT</th>
                ...
                <tbody>
                  @foreach ($gioithieu as $g)
                    <tr>
                      ...
                      <td style="text-align: center;">{{$g->TieuDe}}</td>
                      @if($g->Anh != '')
                        <td style="text-align: center;">
                          <img  style="width: 120px; height: 120px;" src="assets/custom/Anh/GTLH/{{$g->Anh}}"/>
                        </td>
                        @else 
                        <td style="text-align: center;">
                      ...
                      @endif
                      <td>{{Str::limit($g->MoTa, 200) }}</td>
                      <td style="text-align: center;">
                        <form action="/qlgioithieu_update/{{$g->id}}" method="GET">
                      ...
                      <td style="text-align: center;">
                        <form action="/deleteGioiThieu/{{$g->id}}" method="POST" id="delete-form">
                          @csrf
                          @method('DELETE')
              ...
              <div class="paginate" style="text-align: center">
                {{$gioithieu->appends(request()->all())->links()}}
              </div>
              <!-- End phân trang-->
